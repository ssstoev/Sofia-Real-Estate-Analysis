...
from backend.scraper.rents.src.database import insert_rents_ad
...
def run_harvester():
    ...
    while has_next_page:
        # Construct URL
        current_page_url = f'https://www.imoti.net/bg/obiavi/r/dava-pod-naem/sofia?page={page_number}'
        ...
        try:
            ...
            insert_rents_ad(cursor, single_page_ads)
